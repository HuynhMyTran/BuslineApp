"""
Django settings for buslineapp project.
...
SECRET_KEY = 'django-insecure-il1wjimws@%pp^wkq2_fdj82t5e)q(#5ea1*_km-s3cp1%t9%z'
...
WSGI_APPLICATION = 'buslineapp.wsgi.application'
